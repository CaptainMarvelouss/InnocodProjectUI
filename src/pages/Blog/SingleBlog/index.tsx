...
export function Blog() {
    ...
    <header className="page-header page-header-mini">
        <h1 className="title">Voluptates Corporis Placeat</h1>
            ...
            <div className="page-content">
                <div className="card">
                    <div className="card-header pt-0">
                        <h3 className="card-title mb-4">Voluptates Corporis Placeat</h3>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="card mb-5">
                            ...
                            <div className="card-body px-0">
                                <h6 className="card-title mb-2"><a href="#" className="text-dark">Voluptates Corporis Placeat</a></h6>  
