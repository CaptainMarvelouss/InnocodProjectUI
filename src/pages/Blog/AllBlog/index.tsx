        ...
        <div className="container">
            <section>
                <div className="feature-posts">
                    ...
                    <a href="single-post.html" className="feature-post-item">
                        <img src="src/assets/imgs/img-1.jpg" className="w-100" alt=""/>
                        <div className="feature-post-caption">Incidunt Quaerat</div>
                    </a>
                    <a href="single-post.html" className="feature-post-item">
                        <img src="src/assets/imgs/img-2.jpg" className="w-100" alt=""/>
                        <div className="feature-post-caption">Culpa Ducimus</div>
                    </a>
                    <a href="single-post.html" className="feature-post-item">
                        <img src="src/assets/imgs/img-3.jpg" className="w-100" alt=""/>
                        <div className="feature-post-caption">Temporibus Simile</div>
                    </a>
                    <a href="single-post.html" className="feature-post-item">
                        <img src="src/assets/imgs/img-4.jpg" className="w-100" alt=""/>
            ...
            <div className="page-container">
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div className="blog-media">
                                <img src="src/assets/imgs/blog-6.jpg" alt="" className="w-100"/>
                    ...
                    <div className="row">                       
                        ...
                        <div className="col-lg-6">
                            <div className="card text-center mb-5">
                                <div className="card-header p-0">                                   
                                    <div className="blog-media">
                                        <img src="src/assets/imgs/blog-5.jpg" alt="" className="w-100"/>
                    ...
                    <div className="row">                       
                        <div className="col-lg-6">
                            <div className="card text-center mb-5">
                                <div className="card-header p-0">                                   
                                    <div className="blog-media">
                                        <img src="src/assets/imgs/blog-1.jpg" alt="" className="w-100"/>
                        ...
                        <div className="col-lg-6">
                            <div className="card text-center mb-5">
                                <div className="card-header p-0">                                   
                                    <div className="blog-media">
                                        <img src="src/assets/imgs/blog-7.jpg" alt="" className="w-100"/>
                ...
                <div className="page-sidebar text-center">
                    ...
                    <img src="src/assets/imgs/avatar.jpg" alt="" className="circle-100 mb-3"/>
                    ...
                    <div className="row px-3">
                        <div className="col-4 p-1 figure">
                            <a href="#" className="figure-img">
                                <img src="src/assets/imgs/insta-1.jpg" alt=""/>
                            </a>
                        </div>
                        <div className="col-4 p-1 figure">
                            <a href="#" className="figure-img">
                                <img src="src/assets/imgs/insta-2.jpg" alt="" className="w-100 m-0"/>
                            </a>
                        </div>  
                        <div className="col-4 p-1 figure">
                            <a href="#" className="figure-img">
                        ...
                        <div className="col-4 p-1 figure">
                            <a href="#" className="figure-img">
                                <img src="src/assets/imgs/insta-4.jpg" alt="" className="w-100 m-0"/>
                            </a>
                        </div>  
                        <div className="col-4 p-1 figure">
                            <a href="#" className="figure-img">
                        ...
                        <div className="col-4 p-1 figure">
                            <a href="#" className="figure-img">
                                <img src="src/assets/imgs/insta-6.jpg" alt="" className="w-100 m-0"/>
                            </a>
                        </div>                          
                    </div>  
                    ...
                    <figure className="figure mt-5">
                        <a href="single-post.html" className="figure-img">
                            <img src="src/assets/imgs/img-4.jpg" alt="" className="w-100"/>
                    ...
                    <div className="media text-left mb-4">
                        <a href="single-post.html" className="overlay-link"></a>
                        <img className="mr-3" src="src/assets/imgs/blog-1.jpg" width="100px" alt="Generic placeholder image"/>
                    ...
                    <div className="media text-left mb-4">
                        <a href="single-post.html" className="overlay-link"></a>
                        <img className="mr-3" src="src/assets/imgs/blog-2.jpg" width="100px" alt="Generic placeholder image"/>
                        <div className="media-body">
                    ...
                    <div className="media text-left mb-4">
                        <a href="single-post.html" className="overlay-link"></a>
                        <img className="mr-3" src="src/assets/imgs/blog-3.jpg" width="100px" alt="Generic placeholder image"/>
                        <div className="media-body">
